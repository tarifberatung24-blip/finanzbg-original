...
export default function LoginPage() {
  ...
  const de = locale === "de"
  const copy = de ? { title: "Anmelden oder registrieren", intro: "Sicher anmelden und deinen Finanzbereich öffnen.", google: "Mit Google fortfahren", or: "oder", phone: "Deutsche Mobilnummer", send: "Code senden", sending: "Wird gesendet…", otp: "SMS-Code eingeben", verify: "Anmeldung bestätigen", verifying: "Prüfung…", email: "E-Mail oder Passwort ist nicht korrekt.", signup: "Konto erstellen", existing: "Schon registriert?", login: "Anmelden", noAccount: "Noch kein Konto?" } : { title: "Вход или регистрация", intro: "Влез сигурно и отвори финансовия си раздел.", google: "Продължи с Google", or: "или", phone: "Немски мобилен номер", send: "Изпрати код", sending: "Изпращане…", otp: "Въведи SMS кода", verify: "Потвърди входа", verifying: "Проверка…", email: "Имейлът или паролата не са правилни.", signup: "Създай акаунт", existing: "Вече си регистриран?", login: "Вход", noAccount: "Все още нямаш акаунт?" }
